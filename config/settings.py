...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-temp-key-for-development-only-change-this')
...
# Whitenoise для сжатия и кеширования статики
STORAGES = {
    "staticfiles": {
...
# Используй Cloudinary для медиафайлов если настроено
